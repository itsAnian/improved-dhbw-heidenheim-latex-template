...
\input{content/documentInfo}

% Load language specific Strings
\input{config/lang/\documentLanguage}
...
% Cite like in Guidelines "Author (year)[bibliographie]"
\newcommand{\glcite}[1]{\citeauthor{#1}~(\citeyear{#1})\cite{#1}}
...
% Bessere linebreaks innerhalb von URLs der Bibliographie
\setcounter{biburllcpenalty}{700}
